        ...
        try {
            ...
            for (int i = 0; i < itemNodeList.getLength(); i++) {
                ...
                if (title.contains(searchString)) {
                    ...
                    System.out.println("description:" + xPath.evaluate("description/text()", itemNode, XPathConstants.STRING));
                }
            }
